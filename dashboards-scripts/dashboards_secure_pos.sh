...
DASHBOARDS_VERSION=$(/usr/share/opensearch-dashboards/bin/opensearch-dashboards --config /etc/opensearch-dashboards/opensearch-dashboards.yml --allow-root --version)
