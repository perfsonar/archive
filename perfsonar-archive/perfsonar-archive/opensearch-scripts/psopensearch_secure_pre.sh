...
JVM_FILE=${OPENSEARCH_CONFIG_DIR}/jvm.options.d/90-perfsonar-ram.options
...
## UPDATE BLOCK: Removing incompatible settings and adding required ones for OpenSearch 3.6
